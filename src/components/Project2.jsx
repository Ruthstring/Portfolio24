  ...
  return (
    <div className="section-container flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 lg:mt-40 min-h-screen">
      ...
      <div className="project-text w-full md:w-1/3 h-auto">
        <h1 className="lg:absolute text-3xl lg:text-6xl font-bold mb-4 text-left lg:ml-4">
          Donut e-commerce
        </h1>
          ...
          return (
            <img
              ...
              className={`absolute transition-transform transform duration-1000 ease-in-out
                 ...
                 ${isLeft ? "translate-x-[-100px] md:translate-x-[-190px] lg:translate-x-[-250px] xl:translate-x-[-220px] 2xl:translate-x-[-400px] z-20" : ""}
                 ${isRight ? "translate-x-[100px] md:translate-x-[190px] lg:translate-x-[250px] xl:translate-x-[220px] 2xl:translate-x-[400px] z-20" : ""}
              `}
              style={{
...
//       {/* Slider Section */}
//       <div className="project-media md:w-2/3 lg:w-4/5 pt-20 md:pl-20 lg:pl-48 flex justify-center items-center relative md:h-96">
//         {/* Map through images and position them */}
//         {images.map((image, index) => {
//           const isActive = index === activeIndex;
//           const isLeft = index === (activeIndex - 1 + images.length) % images.length;
...
//               className={`absolute transition-transform transform duration-1000 ease-in-out
//                  ${isActive ? "scale-125 z-30" : "opacity-50"}
//                  ${isLeft ? "translate-x-[-100px] md:translate-x-[-190px] lg:translate-x-[-250px] xl:translate-x-[-300px] z-20" : ""}
//                  ${isRight ? "translate-x-[100px] md:translate-x-[190px] lg:translate-x-[250px] xl:translate-x-[300px] z-20" : ""}
//               `}
//               style={{
//                 width: isActive ? "50%" : "40%",
//                 cursor: "pointer",
...
//               src={image.src}
//               alt={image.alt}
//               className={`absolute transition-transform transform duration-1000 ease-in-out lg:mr-28 lg:mt-20
//                  ${isActive ? "scale-125 z-30 " : ""}
//                  ${isLeft ? "translate-x-[-100px] md:translate-x-[-190px] lg:translate-x-[-250px] xl:translate-x-[-500px] z-20 opacity-50" : ""}
//                  ${isRight ? "translate-x-[100px] md:translate-x-[190px] lg:translate-x-[250px] xl:translate-x-[500px]  z-20 opacity-50" : ""}
//               `}
//               style={{
//                 width: isActive ? "50%" : "40%",
//                 cursor: "pointer",
