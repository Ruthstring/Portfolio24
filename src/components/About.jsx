  ...
  return (
    <div id="about" className="about-container pb-12">
      ...
      <div className="about-grid grid grid-cols-5 md:grid-cols-12 grid-rows-auto md:grid-rows-auto h-screen 2xl:h-[80vh] ">
        ...
        {/* Intro Text */}
        <div className="intro-text row-start-2 col-start-2 row-span-2 col-span-7 md:col-span-6 md:col-start-6 2xl:col-span-5  md:row-start-1 md:pb-2 2xl:pb-6">
          <p className="text-left text-[20px] md:text-[30px] 2xl:text-[50px] leading-8 md:leading-10">
