  ...
  return (
    <div ref={contactRef} className="h-screen xl:h-screen 2xl:h-[90%] container contact-section ">
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 2xl:grid-cols-12 w-full h-full">
        ...
        <div className="text-animation-container pt-20 md:pt-28 lg:col-span-1 2xl:col-span-5 flex flex-col items-start  relative 2xl:mt-10">
          {showAnimation && (
            <h2 className={`transition-all duration-1000 text-[40px] md:text-[50px] text-6xl md:text-8xl xl:text-[60px] font-bold text-white
          ...
          {showAnimation && (
            <h2
              ...
              className={`transition-all text-left font-bold text-[40px] mb-5 md:mt-0 md:text-[60px] xl:text-[80px] 2xl:mt-12 2xl:pt-3 duration-1000 md:text-8xl text-white relative
        ...
        <div className="contact-info-section flex items-center 2xl:col-span-5 pl-8 md:pl-0 text-white">
